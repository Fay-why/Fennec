...
class Experiment:
    ...
    def __init__(self, methods:Dict[str, TransferabilityMethod], budget:int=500, runs:int=5, probe_only:bool=False, model_bank:str='large', append:bool=False, name:str=None, full=False):
        if full:
    ...
    def evaluate(self):
        ...
        params = self.probe()
        print(f"feats shape = {params['features'].shape}")
        if self.probe_only:
            return
